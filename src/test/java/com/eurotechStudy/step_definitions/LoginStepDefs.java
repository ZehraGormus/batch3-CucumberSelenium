...
public class LoginStepDefs {
    ...
    public void the_user_enters_student_credentials() {
        System.out.println("The user enters student credentials");

    }

    @When("the user enters developer credentials")
    public void the_user_enters_developer_credentials() {
        System.out.println("The user enters developer credentials");

    }

    @When("the user enters tester credentials")
    public void the_user_enters_tester_credentials() {

        System.out.println("The user enters tester credentials");
    }
